...
import (
	...
	testExclusiveMaximum "github.com/kainwinterheart/go-jsonschema/tests/data/validation/exclusiveMaximum"
	testExclusiveMinimum "github.com/kainwinterheart/go-jsonschema/tests/data/validation/exclusiveMinimum"
	testMaxLength "github.com/kainwinterheart/go-jsonschema/tests/data/validation/maxLength"
	testMaximum "github.com/kainwinterheart/go-jsonschema/tests/data/validation/maximum"
	testMinLength "github.com/kainwinterheart/go-jsonschema/tests/data/validation/minLength"
	testMinimum "github.com/kainwinterheart/go-jsonschema/tests/data/validation/minimum"
	testMultipleOf "github.com/kainwinterheart/go-jsonschema/tests/data/validation/multipleOf"
	testPattern "github.com/kainwinterheart/go-jsonschema/tests/data/validation/pattern"
	testPrimitiveDefs "github.com/kainwinterheart/go-jsonschema/tests/data/validation/primitive_defs"
	testReadOnlyFields "github.com/kainwinterheart/go-jsonschema/tests/data/validation/readOnly"
	testReadOnlyAndRequiredFields "github.com/kainwinterheart/go-jsonschema/tests/data/validation/readOnlyAndRequired"
	testRequiredFields "github.com/kainwinterheart/go-jsonschema/tests/data/validation/requiredFields"
	testReadOnlyValidationDisabledFields "github.com/kainwinterheart/go-jsonschema/tests/data/validationDisabled/readOnly"
	"github.com/kainwinterheart/go-jsonschema/tests/helpers"
)
