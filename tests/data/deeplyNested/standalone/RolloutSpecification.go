...
func (j *applyacrossserviceresources) UnmarshalJSON(value []byte) error {
	...
	type applyacrossserviceresourcesHelper struct {
		...
		Deployarmresources *bool    `json:"deployArmResources,omitempty,omitzero"`
		Names              []string `json:"names"`
	}
...
func (j *configuration) UnmarshalJSON(value []byte) error {
	type configurationHelper struct {
		Servicescope *servicescope `json:"serviceScope,omitempty,omitzero"`
	}
	type Plain configuration
...
func (j *email) UnmarshalJSON(value []byte) error {
	...
	type emailHelper struct {
		Cc      *string  `json:"cc,omitempty,omitzero"`
		Options *options `json:"options,omitempty,omitzero"`
		To      string   `json:"to"`
	}
	type Plain email
...
func (j *incident) UnmarshalJSON(value []byte) error {
	...
	type incidentHelper struct {
		Options      *incidentoptions `json:"options,omitempty,omitzero"`
...
func (j *notification) UnmarshalJSON(value []byte) error {
	type notificationHelper struct {
		...
		Incident *incident `json:"incident,omitempty,omitzero"`
	}
	type Plain notification
...
func (j *options) UnmarshalJSON(value []byte) error {
	type optionsHelper struct {
		Verbosity *string  `json:"verbosity,omitempty,omitzero"`
		When      []string `json:"when,omitempty,omitzero"`
	}
	type Plain options
...
func (j *orchestratedstep) UnmarshalJSON(value []byte) error {
	...
	type orchestratedstepHelper struct {
		...
		Applications *applications `json:"applications,omitempty,omitzero"`
		Dependson    []string      `json:"dependsOn,omitempty,omitzero"`
...
func (j *properties) UnmarshalJSON(value []byte) error {
	...
	type propertiesHelper struct {
		...
		Correlateby *string `json:"correlateBy,omitempty,omitzero"`
...
func (j *rolloutmetadata) UnmarshalJSON(value []byte) error {
	...
	type rolloutmetadataHelper struct {
		...
		Configuration             *configuration           `json:"configuration,omitempty,omitzero"`
		Name                      string                   `json:"name"`
		Notification              *notification            `json:"notification,omitempty,omitzero"`
		Parameterreplacementspath *string                  `json:"parameterReplacementsPath,omitempty,omitzero"`
		Rolloutpolicyreferences   []rolloutpolicyreference `json:"rolloutPolicyReferences,omitempty,omitzero"`
...
func (j *servicescope) UnmarshalJSON(value []byte) error {
	type servicescopeHelper struct {
		Specpath *string `json:"specPath,omitempty,omitzero"`
	}
