...
import (
	...
	"github.com/kainwinterheart/go-jsonschema/pkg/generator"
)
	...
	cfg.SchemaMappings = []generator.SchemaMapping{
		{
			...
			PackageName: "github.com/kainwinterheart/go-jsonschema/tests/helpers/schema",
			OutputName:  "schema.go",
		},
		{
			SchemaID:    "https://example.com/other",
			PackageName: "github.com/kainwinterheart/go-jsonschema/tests/data/crossPackage/other",
...
func TestCrossPackageAllOf(t *testing.T) {
	...
	cfg.SchemaMappings = []generator.SchemaMapping{
		...
		{
			SchemaID:    "https://example.com/other",
			PackageName: "github.com/kainwinterheart/go-jsonschema/tests/data/crossPackageAllOf/other",
			OutputName:  "../other/other.go",
		},
	}
...
func TestCrossPackageNoOutput(t *testing.T) {
	...
	cfg.SchemaMappings = []generator.SchemaMapping{
		...
		{
			SchemaID:    "https://example.com/other",
			PackageName: "github.com/kainwinterheart/go-jsonschema/tests/helpers/other",
		},
	}
