...
* **Download**: Get a release [here](https://github.com/kainwinterheart/go-jsonschema/releases).

* **Install from source**: To install with Go 1.25+:

```shell
go get github.com/kainwinterheart/go-jsonschema/...
go install github.com/kainwinterheart/go-jsonschema@latest
```
